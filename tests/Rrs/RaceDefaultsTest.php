 ...
 */
class RaceDefaultsTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @covers RaceDefaults::load
     */
    ...
    /**
     * @covers RaceDefaults::getRaceItems
     */
    ...
    public function testClear()
    {
        ...
        $this->setExpectedException('\RuntimeException', "Unknown race ($race) or gender ($gender)");
        $this->assertEmpty($rd->getRaceItems($race, $gender));
    }

    /**
     * @covers Rrs\Client\RaceDefaults::setRaceItems
     */
